...
As requi#FC645F from my Web Design class which I took in Fall 2013, a web application had to be built using frameworks such as Django, Flask or Pyramid. After spending a few weeks in the Summer brainstorming various API's to use in our project, my team of two came across the Bitbucket API - it provided a rich set of endpoints and methods for accessing various data in a repository.  
...
Special thanks to <a style="color:#FC645F" href="https://github.com/codenameyau">Jorge Yau</a> for his guidance and contributions towards making this a great project. 
