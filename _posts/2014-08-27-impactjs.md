...
<a style="color:#1faa9b" href="http://jeremyneiman.com/zombie/">building</a> 
<a style="color:#1faa9b" href="http://drksephy.bitbucket.org/">three</a> <a style="color:#1faa9b" href="https://drksephy.github.io//fireemblem/"> games </a> 
using the <a style="color:#1faa9b" href="http://impactjs.com/">ImpactJS Game Engine</a> within the City College of New York (CCNY) Game development club. This tutorial serves as a guide for building a simple platformer game using ImpactJS and is intended for all audiences. 
...
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="http://www.codecademy.com/en/tracks/javascript">CodeAcademy JavaScript course</a>
...
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="https://try.github.io/levels/1/challenges/3">Git interactive tutorial</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="https://help.github.com/articles/set-up-git">Guide to Git/Github</a>
...
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="https://addons.mozilla.org/en-US/firefox/addon/firebug/">Firebug download</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="http://getfirebug.com/whatisfirebug">Firebug tutorial</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="https://developer.chrome.com/devtools">Developer tools tutorial</a>
...
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="https://github.com/DrkSephy/ACM-Game-Presentation">Download completed tutorial source code</a>
...
Within the root folder `tutorial`, place `weltmeister.html` (received from purchasing ImpactJS), `server.py` (obtained from <a style="color:#1faa9b" href="https://github.com/amadeus/python-impact" > here </a>), and `index.html` (also received from purchasing ImpactJS). Within `tutorial/lib`, place the `impact` and `weltmeister` folders. Lastly, you may obtain all of the media for this project <a style="color:#1faa9b" href="https://github.com/DrkSephy/ACM-Game-Presentation" > here </a>. 
...
This tutorial will reference the use of `Weltmeister`, ImpactJS's built in Tile Editor program often. However, usage of `Weltmeister` will not be covered here, as there already exists a great video on using Weltmeister by ImpactJS's own creator, Dominic Szablewski. See the references below for learning to use `Weltmeister`. 

<i class="fa fa-file-video-o"></i> <a style="color:#1faa9b" href="http://impactjs.com/documentation/video-tutorial-weltmeister">Weltmeister Video </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="http://impactjs.com/documentation/weltmeister">Weltmeister Documentation</a>
...
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="http://impactjs.com/documentation/class-reference/game">Read ImpactJS Game Class Documentation</a>
...
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="http://impactjs.com/documentation/class-reference/animation">Read Animation Documentation</a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="http://impactjs.com/documentation/class-reference/animationsheet">Read Animation Sheet Documentation</a>
...
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="http://impactjs.com/documentation/class-reference/input">Read Input Documentation</a>
...
![fixed-movement](/img/fixed_movement.gif){: .post-img}
...
![fixed-animation](/img/fixed_animations.gif){: .post-img}
...
![fixed-movement](/img/physics.gif){: .post-img}
...
![fixed-movement](/img/goomba.gif){: .post-img}
...
![fixed-movement](/img/wall.gif){: .post-img}
...
![fixed-movement](/img/fixed_wall.gif){: .post-img}
...
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="http://impactjs.com/documentation/class-reference/entity#handlemovementtrace">Read handleMovementTrace Documentation</a>
...
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="http://impactjs.com/documentation/class-reference/entity#type">Read Entity Type Documentation</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="http://impactjs.com/documentation/class-reference/entity#checkagainst">Read Entity checkAgainst Documentation</a>
...
![fixed-movement](/img/collide.gif){: .post-img}
...
![fixed-movement](/img/kill.gif){: .post-img}
...
<i class="fa fa-files-o"></i> <a style="color:#1faa9b" href="http://impactjs.com/documentation/class-reference/entity#receivedamage">Read receiveDamage Documentation</a>
...
![fixed-movement](/img/health.gif){: .post-img}
...
![fixed-movement](/img/mushroom.gif){: .post-img}
