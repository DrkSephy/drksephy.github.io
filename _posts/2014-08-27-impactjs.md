...
![server.py]({{ site.url }}/img/server.gif)
...
![left-right-movement]({{ site.url }}/img/left_right.gif)
...
![fixed-movement]({{ site.url }}/img/fixed_movement.gif)
...
![fixed-animation]({{ site.url }}/img/fixed_animations.gif)
...
![fixed-movement]({{ site.url }}/img/physics.gif)
...
![fixed-movement]({{ site.url }}/img/goomba.gif)
...
![fixed-movement]({{ site.url }}/img/wall.gif)
...
![fixed-movement]({{ site.url }}/img/fixed_wall.gif)
...
![fixed-movement]({{ site.url }}/img/collide.gif)
...
![fixed-movement]({{ site.url }}/img/kill.gif)
...
![fixed-movement]({{ site.url }}/img/health.gif)
...
![fixed-movement]({{ site.url }}/img/jump_kill.gif)
...
![fixed-movement]({{ site.url }}/img/mushroom.gif)
