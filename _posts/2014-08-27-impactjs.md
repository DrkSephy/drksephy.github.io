...
Throughout Spring 2013 - Fall 2014, I have taken part in <a href="http://jeremyneiman.com/zombie/">building</a> <a href="http://drksephy.bitbucket.org/" >three </a> <a href="http://drksephy.github.io//fireemblem/" >games</a> using the <a href="http://impactjs.com/">ImpactJS Game Engine</a> within the City College of New York (CCNY) Game development club. This tutorial serves as a guide for building a simple platformer game using ImpactJS and is intended for all audiences. 
...
<i class="fa fa-files-o"></i> <a href="http://www.codecademy.com/en/tracks/javascript">CodeAcademy JavaScript course</a>
...
<i class="fa fa-files-o"></i> <a href="https://try.github.io/levels/1/challenges/3">Git interactive tutorial</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-files-o"></i> <a href="https://help.github.com/articles/set-up-git">Guide to Git/Github</a>
...
![server.py]({{ site.url }}/images/server.gif)
...
<i class="fa fa-file-video-o"></i> <a href="http://impactjs.com/documentation/video-tutorial-weltmeister">Weltmeister Video </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<i class="fa fa-files-o"></i> <a href="http://impactjs.com/documentation/class-reference/game">Read ImpactJS Game Class Documentation</a>
...
<i class="fa fa-files-o"></i> <a href="http://impactjs.com/documentation/class-reference/animation">Read Animation Documentation</a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-files-o"></i> <a href="http://impactjs.com/documentation/class-reference/animationsheet">Read Animation Sheet Documentation</a>
...
<i class="fa fa-files-o"></i> <a href="http://impactjs.com/documentation/class-reference/input">Read Input Documentation</a>
...
![left-right-movement]({{ site.url }}/images/left_right.gif)
...
![fixed-movement]({{ site.url }}/images/fixed_movement.gif)
...
![stuck]({{ site.url }}/images/stuck.gif)
...
![fixed-animation]({{ site.url }}/images/fixed_animations.gif)
...
![fixed-movement]({{ site.url }}/images/physics.gif)
...
![fixed-movement]({{ site.url }}/images/goomba.gif)
...
![fixed-movement]({{ site.url }}/images/wall.gif)
...
![fixed-movement]({{ site.url }}/images/fixed_wall.gif)
...
![fixed-movement]({{ site.url }}/images/collide.gif)
...
![fixed-movement]({{ site.url }}/images/kill.gif)
...
<i class="fa fa-files-o"></i> <a href="http://impactjs.com/documentation/class-reference/entity#receivedamage">Read receiveDamage Documentation</a>
...
![fixed-movement]({{ site.url }}/images/health.gif)
...
![fixed-movement]({{ site.url }}/images/jump_kill.gif)
...
![fixed-movement]({{ site.url }}/images/mushroom.gif)
...
![debug]({{ site.url }}/images/debug.png)
