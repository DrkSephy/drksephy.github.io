...
At the time of starting this streak, I had limited experience with web technologies, JavaScript, Python, or anything discussed here. Needless to say, I was a mediocre developer with little motivation to learn or to build projects. Throughout the course of the streak I discovered my likes while at the same time building up my skillset and resume. While the projects here may not all be the most exciting or intricate, these projects helped shaped me as a programmer.
