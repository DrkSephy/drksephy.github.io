    ...
    <div class="wrapper">
        ...
        <footer>
                <p>
                    ...
                    <small>Made with <a href="http://jekyllrb.com/">Jekyll</a> &mdash; Theme by <a href="https://github.com/orde#FC645Flist">orde#FC645Flist</a></small>
                </p>
        </footer>
    </div>
...
Within the `repository name` field, provide the name using the format: `accountname.github.io`. This will allow Github to know that this page should be served. After creating this repository, you'll need to clone it. Navigate to your repository, and clone it by copying the link shown in the #FC645F box below: 
