...
To clone a repository containing the final product, you can do so <a style="color:#1faa9b" href="https://github.com/DrkSephy/ACM-Portfolio-Presentation">here</a>.
...
The source code for `jquery.bxslider.css` is located <a style="color:#1faa9b" href="https://raw.githubusercontent.com/DrkSephy/drksephy.github.io/master/css/jquery.bxslider.css">here</a>.
...
The source code for `jquery.bxslider.min.js` is located <a style="color:#1faa9b" href="https://raw.githubusercontent.com/DrkSephy/drksephy.github.io/master/js/jquery.bxslider.min.js">here</a>.
...
<div class="wrapper">
    <section>
        {% for post in site.posts %}
            ...
            <p class="post-excerpt">{{ post.excerpt | strip_html }} [<a style="color:#1faa9b" href="{{ post.url }}">read more</a>]</p>
